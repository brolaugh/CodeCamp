...
<body onload="init();">
	<div id="splash">
		<ul>
			<li class="form-choice"><a href="javascript:void(0); showLoginForm()" class="btn btn-default btn-raised">Login</a></li>
			<li class="form-choice"><a href="javascript:void(0); showRegForm()" class="btn btn-default btn-raised">Register</a></li>
		</ul>
			<?php
				require_once('templates/main-login.php');
				require_once('templates/main-register.php');
			?>
		<a class="forgott-password" href="forgot-password">forgot your password?</a>
	</div>
	<?php
